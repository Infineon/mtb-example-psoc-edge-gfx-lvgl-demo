/*******************************************************************************
* File Name        : lv_demo_music_list.c
*
* Description      : This file contains the implementation of the music list
*                    screen in the LVGL music demo. It manages the list of
*                    songs, item creation, layout, and user interaction logic.
*
...
lv_obj_t * lv_demo_music_list_create(lv_obj_t * parent)
{
    ...
    lv_obj_set_size(list, LV_HOR_RES-32, LV_VER_RES - LV_DEMO_MUSIC_HANDLE_SIZE);
#else /*defined(MTB_DISPLAY_W4P3INCH_RPI)*/
    lv_obj_set_size(list, LV_HOR_RES, LV_VER_RES - LV_DEMO_MUSIC_HANDLE_SIZE);
#endif /*defined(MTB_DISPLAY_W4P3INCH_RPI)*/
